...
app.get('/team_stats', function(req, res) {
  var query1="SELECT * from football_games where game_date>'2018-01-01' and game_date<'2019-01-01'";
...
// Get the football players' information
app.get('/player_info/post', function(req,res){
  ...
  if(playerId != "Select Player"){
    var name = 'SELECT id,name FROM football_players;';
    var stats = 'SELECT year,major,passing_yards,rushing_yards,receiving_yards FROM football_players WHERE id = ' + playerId + ';';
    var games = 'SELECT COUNT(*) FROM football_games WHERE ' + playerId + '=ANY(players);';
    db.task('get-everything', task => {
      return task.batch([
        task.any(name),
        task.any(stats),
